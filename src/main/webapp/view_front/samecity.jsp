	...
	<div class="m-5">
		<div class="row">
			...
			<div class="  2  col-3  col-sm-8"
				...
				<div class="m-5">
					<div class="card"  style="height: 220px; margin-top: -20px; margin-bottom: 23px;background:url(../img/bg4.jpg) 745px 220px"  id="card">
						<div class="form-group" style="margin-left: 100px;">
							<h6 class="title111" style="font-family: "Arial","Microsoft YaHei","黑体","宋体",sans-serif;">请写你的动态</h6>
							<form action="<%=basePath%>blog/uploadblog"
								class="uploadblogForm" method="post">
								<div id="editor">

									<textarea rows="1" cols="40" name="blogContent"
					...
					<!-- 1 -->
						<div class="card" style="opacity: 0" id="card1">
							...
							<div style="margin-top: -30px">
								...
								<p
									style="margin-left: 20px; margin-top: -25px; color：gray; font-size: 15px">${bloglist[0].blogPublishTime }&nbsp&nbsp&nbsp<small id="cardweizhi">${bloglist[0].blogPublishPlace}</small></p>
						...
						<div class="card" style="opacity: 0" id="card2">
							...
							<div style="margin-top: -30px">
								...
								<p id="pinglun" class="pinglun" onclick="pinglunmethod(1)"
									style="margin-left: 1000px; margin-top: -25px; color：gray; font-size: 15px; cursor: pointer;">评论</p>
								<p
									style="margin-left: 20px; margin-top: -25px; color：gray; font-size: 15px">${bloglist[1].blogPublishTime }&nbsp&nbsp&nbsp<small id="cardweizhi">${bloglist[1].blogPublishPlace}</small></p>
								<p style="margin-top: 15px;"></p>
							</div>
							<!-- 评论2-->
							<div id="commentfather" class="commentfather">
						...
						<div class="card" style="opacity: 0" id="card3">
							...
							<div style="margin-top: -30px">
								...
								<p id="pinglun" class="pinglun" onclick="pinglunmethod(2)"
									style="margin-left: 1000px; margin-top: -25px; color：gray; font-size: 15px; cursor: pointer;">评论</p>
								<p
									style="margin-left: 20px; margin-top: -25px; color：gray; font-size: 15px">${bloglist[2].blogPublishTime }&nbsp&nbsp&nbsp<small id="cardweizhi">${bloglist[2].blogPublishPlace}</small></p>
								<p style="margin-top: 15px;"></p>
							</div>
							<!-- 评论3 -->
							<div id="commentfather" class="commentfather">
						...
						<div class="card" style="opacity: 0" id="card4">
							...
							<div style="margin-top: -30px">
								...
								<p id="pinglun" class="pinglun" onclick="pinglunmethod(3)"
									style="margin-left: 1000px; margin-top: -25px; color：gray; font-size: 15px; cursor: pointer;">评论</p>
								<p
									style="margin-left: 20px; margin-top: -25px; color：gray; font-size: 15px">${bloglist[3].blogPublishTime }&nbsp&nbsp&nbsp<small id="cardweizhi">${bloglist[3].blogPublishPlace}</small></p>
								<p style="margin-top: 15px;"></p>
							</div>
							<!-- 评论4 -->
							<div id="commentfather" class="commentfather">
						...
						<div class="card" style="opacity: 0" id="card5">
							...
							<div style="margin-top: -30px">
								...
								<p id="pinglun" class="pinglun" onclick="pinglunmethod(4)"
									style="margin-left: 1000px; margin-top: -25px; color：gray; font-size: 15px; cursor: pointer;">评论</p>
								<p
									style="margin-left: 20px; margin-top: -25px; color：gray; font-size: 15px">${bloglist[4].blogPublishTime }&nbsp&nbsp&nbsp<small id="cardweizhi">${bloglist[4].blogPublishPlace}</small></p>
								<p style="margin-top: 15px;"></p>
							</div>
							<!-- 评论5 -->
							<div id="commentfather" class="commentfather">
						...
						<div class="card" style="opacity: 0" id="card6">
							...
							<div style="margin-top: -30px">
								...
								<p id="pinglun" class="pinglun" onclick="pinglunmethod(5)"
									style="margin-left: 1000px; margin-top: -25px; color：gray; font-size: 15px; cursor: pointer;">评论</p>
								<p
									style="margin-left: 20px; margin-top: -25px; color：gray; font-size: 15px">${bloglist[5].blogPublishTime }&nbsp&nbsp&nbsp<small id="cardweizhi">${bloglist[5].blogPublishPlace}</small></p>
								<p style="margin-top: 15px;"></p>
							</div>
							<!-- 评论6 -->
							<div id="commentfather" class="commentfather">
						...
						<div class="card" style="opacity: 0" id="card7">
							...
							<div style="margin-top: -30px">
								...
								<p id="pinglun" class="pinglun" onclick="pinglunmethod(6)"
									style="margin-left: 1000px; margin-top: -25px; color：gray; font-size: 15px; cursor: pointer;">评论</p>
								<p
									style="margin-left: 20px; margin-top: -25px; color：gray; font-size: 15px">${bloglist[6].blogPublishTime }&nbsp&nbsp&nbsp<small id="cardweizhi">${bloglist[6].blogPublishPlace}</small></p>
								<p style="margin-top: 15px;"></p>
							</div>
							<!-- 评论7 -->
							<div id="commentfather" class="commentfather">
						...
						<div class="card" style="opacity: 0" id="card8">
							...
							<div style="margin-top: -30px">
								...
								<p id="pinglun" class="pinglun" onclick="pinglunmethod(7)"
									style="margin-left: 1000px; margin-top: -25px; color：gray; font-size: 15px; cursor: pointer;">评论</p>
								<p
									style="margin-left: 20px; margin-top: -25px; color：gray; font-size: 15px">${bloglist[7].blogPublishTime }&nbsp&nbsp&nbsp<small id="cardweizhi">${bloglist[7].blogPublishPlace}</small></p>
								<p style="margin-top: 15px;"></p>
							</div>
							<!-- 评论8 -->
							<div id="commentfather" class="commentfather">
						...
						<div class="card" style="opacity: 0" id="card9">
							...
							<div style="margin-top: -30px">
								...
								<p id="pinglun" class="pinglun" onclick="pinglunmethod(8)"
									style="margin-left: 1000px; margin-top: -25px; color：gray; font-size: 15px; cursor: pointer;">评论</p>
								<p
									style="margin-left: 20px; margin-top: -25px; color：gray; font-size: 15px">${bloglist[8].blogPublishTime }&nbsp&nbsp&nbsp<small id="cardweizhi">${bloglist[8].blogPublishPlace}</small></p>
								<p style="margin-top: 15px;"></p>
							</div>
							<!-- 评论9 -->
							<div id="commentfather" class="commentfather">
						...
						<div class="card" style="opacity: 0" id="card10">
							...
							<div style="margin-top: -30px">
								...
								<p id="pinglun" class="pinglun" onclick="pinglunmethod(9)"
									style="margin-left: 1000px; margin-top: -25px; color：gray; font-size: 15px; cursor: pointer;">评论</p>
								<p
									style="margin-left: 20px; margin-top: -25px; color：gray; font-size: 15px">${bloglist[9].blogPublishTime }&nbsp&nbsp&nbsp<small id="cardweizhi">${bloglist[9].blogPublishPlace}</small></p>
								<p style="margin-top: 15px;"></p>
							</div>
							<!-- 评论10 -->
							<div id="commentfather" class="commentfather">

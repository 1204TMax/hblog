...
<body>
	<div class="container">
		<div class="jumbotron">
			<h1 class="display-3">欢迎加入氢博客</h1>
			<p class="lead">在这之前请在这里填写您的一些资料，值得注意的是
			<P style="">本网站分为弱交友模式和强交友模式，弱交友模式下，您只可以与弱交友模式用户进行主动聊天，并且您的下列资料均为选填。强交友模式下，聊天对象无限制，可以查看对方所有资料，下列资料均为必填。</p>
			</p>
			<p></p>
		</div>
	...
	<div class="container" style="">
		<form class="form-horizontal" action="<%=basePath %>user/adduserinfo" method="post">
			<fieldset>
				<div id="legend" class="">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" placeholder="" class="input-xlarge" name="userinfoOftenPlace">
